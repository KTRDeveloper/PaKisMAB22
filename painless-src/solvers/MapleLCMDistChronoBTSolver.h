...
class MapleLCMDistChronoBTSolver : public SolverInterface
{
public:
   ...
   /// Constructor.
   MapleLCMDistChronoBTSolver(int id);
   
   /// Destructor.
   virtual ~MapleLCMDistChronoBTSolver();
...
protected:
   ...
   friend Minisat::Lit cbkMapleLCMDistChronoBTImportUnit(void *);
   friend bool cbkMapleLCMDistChronoBTImportClause(void *, int *, Minisat::vec<Minisat::Lit> &);
   friend void cbkMapleLCMDistChronoBTExportClause(void *, int, Minisat::vec<Minisat::Lit> &);
};
